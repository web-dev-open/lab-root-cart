...
function calculateAll() {
  ...
  function calculateAll() {
    ...
    // You can also calculate and display the total price for all products here if needed
  
    // Optionally, you can return the total price if you want to use it elsewhere
    // return total;
  }
...
function createProduct() {
  // Get the name and unit price input DOM nodes
  ...
  // Add a click event listener to the "Remove" button for the new product
